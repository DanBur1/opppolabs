...
void displayInfo(const Supply& supply) {
    ...
    {
        cout << " | Плотность: " << supply.attributes[0] << " | Цвет: " << supply.attributes[1];
    }
    if (supply.type == "pen")
    {
        cout << " | Тип: " << supply.attributes[0] << " | Диаметр: " << supply.attributes[1]<< "мм";
    }
    if (supply.type == "paper")
    {
        cout << " | Плотность: " << supply.attributes[0] << "г/м2 | Ширина листа: " << supply.attributes[1] << "мм | Высота листа : " << supply.attributes[2] << "мм";
    }
    cout << endl;
}
